...
describe('Web Components', () => {
    ...
    it('should react to text content changes after attached.', () => new Promise(resolve => {
        const budouxElement = window.document.createElement('budoux-ja');
        budouxElement.textContent = '今日は良い天気です。';
        window.document.body.appendChild(budouxElement);
    ...
    it('should have wrapping styles to control line breaks.', () => {
        ...
        expect((_a = styles.get('word-break')) === null || _a === void 0 ? void 0 : _a.toString()).toBe('keep-all');
        expect((_b = styles.get('overflow-wrap')) === null || _b === void 0 ? void 0 : _b.toString()).toBe('anywhere');
    });
});
